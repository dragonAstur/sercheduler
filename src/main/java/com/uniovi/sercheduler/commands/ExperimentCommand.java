...
public class ExperimentCommand {
  ...
  public String experiment(
    ...
    for (var benchmark : benchmarks) {
      ...
      for (int i = 1; i <= 16; i = i * 2) {
        for (var f : fitness) {
          var benchmarkData = doExperiment(executions, seed, benchmark, type, i, f, random);
  ...
  private static BenchmarkData doExperiment(
      Integer executions,
      Long seed,
      String benchmark,
      String type,
    ...
    var problem =
        new SchedulingProblem(
            new File("/home/pablo/projects/benchmark-data/workflows/" + benchmark + ".json"),
            new File(
                "/home/pablo/projects/benchmark-data/hosts/" + type + "/hosts-" + hosts + ".json"),
            "441Gf",
            fitness,
            seed);
