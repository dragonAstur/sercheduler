...
public class XLSXExporter {
    ...
    public static void export(NeighborhoodObserver observer, String fileName){
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            dataSheet(workbook, observer);

            resumeSheet(workbook, observer);

            detailSheet(workbook, observer);
    ...
    private static void detailSheet(Workbook workbook, NeighborhoodObserver observer) {
    ...
    private static void resumeSheet(Workbook workbook, NeighborhoodObserver observer) {
    ...
    private static void dataSheet(Workbook workbook, NeighborhoodObserver observer){
